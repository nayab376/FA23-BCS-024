import { X, MapPin, Phone, Star, Tag, Calendar, User } from 'lucide-react';
import type { Ad } from '../data/seedProducts';
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="p-6">
          ...
          <p className="text-gray-300 mb-6 leading-relaxed whitespace-pre-line">{ad.description}</p>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {ad.seller_email && (
              <div className="col-span-2 flex items-center gap-2 text-gray-400 bg-gray-800 rounded-lg p-3">
                <User className="w-4 h-4 text-fuchsia-400" />
                <span className="text-sm truncate">
                  Posted by {ad.seller_email}
                  {ad.seller_role ? ` (${ad.seller_role})` : ''}
                </span>
              </div>
            )}
          </div>
